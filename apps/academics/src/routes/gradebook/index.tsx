    ...
    <div className="min-h-full">
        ...
        <div className="px-6 py-8">
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-xl bg-gradient-to-br from-amber-500/20 to-orange-500/20">
              <BookCheck className="w-6 h-6 text-[rgb(var(--state-warning-fg))]" />
            </div>
            <div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-surface-secondary rounded-xl border border-border-secondary p-6">
          <div className="flex items-start gap-4">
            <div className="p-3 rounded-lg bg-[rgb(var(--state-warning-fg))]/10">
              <BookCheck className="w-5 h-5 text-[rgb(var(--state-warning-fg))]" />
            </div>
