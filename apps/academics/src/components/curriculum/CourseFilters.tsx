    ...
    <div className="flex items-center gap-2 flex-wrap">
          ...
          return (
            <button
              ...
              className={`px-2.5 py-1.5 rounded-md text-xs font-medium border transition-colors ${
                isActive
                  ? 'border-[rgb(var(--accent-reports))]/40 bg-[rgb(var(--accent-reports))]/10 text-[rgb(var(--accent-reports))]'
      ...
      {hasFilters && (
        <button
          ...
          className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium text-[rgb(var(--accent-enrollment))] hover:opacity-80 transition-opacity"
        >
          <X className="w-3 h-3" />
          Clear ({filterCount})
        </button>
