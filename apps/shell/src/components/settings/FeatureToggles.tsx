          ...
          >
            ...
            <button
              ...
              className={`
                ...
                ${isEnabled ? 'bg-teal-500' : 'bg-[rgb(var(--surface-tertiary))]'}
                ${disabled ? 'cursor-not-allowed' : 'cursor-pointer'}
                focus:outline-none focus:ring-2 focus:ring-teal-500/40 focus:ring-offset-2 focus:ring-offset-[rgb(var(--surface-primary))]
              `}
              role="switch"
