...
const STATUS_STYLES: Record<string, { bg: string; text: string }> = {
  draft: { bg: 'bg-[rgb(var(--background-tertiary))] ', text: 'text-[rgb(var(--text-secondary))] ' },
  ...
  cancelled: { bg: 'bg-[rgb(var(--background-tertiary))] ', text: 'text-[rgb(var(--text-secondary))] ' },
  written_off: { bg: 'bg-[rgb(var(--background-tertiary))] ', text: 'text-[rgb(var(--text-secondary))] ' },
...
const DEFAULT_STYLE = { bg: 'bg-[rgb(var(--background-tertiary))] ', text: 'text-[rgb(var(--text-secondary))] ' }
