...
export function SchoolSwitcher() {
  ...
  if (!isLoading && schoolsArray.length === 0) {
    if (isTenantAdmin) {
      return (
        ...
        >
          <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-teal-500/20 to-cyan-500/20 border border-dashed border-teal-500/40 flex items-center justify-center flex-shrink-0">
  ...
  if (isStudentOrParent && activeSchool) {
    return (
      <div className="flex items-center gap-[9px] h-10 px-2">
        <img
        ...
        <div className="min-w-0">
          <p className="text-[12.5px] font-semibold truncate max-w-[160px]" style={{ color: 'var(--shell-school-name)' }}>
            {activeSchool.name}
          </p>
  ...
  if (isLoading) {
    return (
      <div className="flex items-center gap-2 h-10 px-2">
        <div className="w-[30px] h-[30px] rounded-lg bg-[rgb(var(--surface-tertiary))] animate-pulse flex-shrink-0" />
  ...
  return (
    <Menu as="div" className="relative">
      <MenuButton
        className="flex items-center gap-[9px] h-10 px-2 rounded-[10px] transition-colors flex-shrink-0"
      ...
      >
        <img
          ...
          alt={activeSchool?.name}
          className={cn(
            'w-[30px] h-[30px] rounded-lg flex-shrink-0',
            isTransitioning && 'animate-pulse'
          )}
        />
        <div className="min-w-0 text-left" style={{ lineHeight: 1.2 }}>
          <p className="text-[12.5px] font-semibold truncate max-w-[160px]" style={{ color: 'var(--shell-school-name)', transition: 'color 0.3s' }}>
