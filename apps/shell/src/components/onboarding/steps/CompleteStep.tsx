  ...
  return (
    <div className="text-center">
      ...
      {summaryItems.length > 0 && (
        <div className="bg-[rgb(var(--background-secondary))] rounded-2xl p-5 border border-[rgb(var(--border-primary))] mb-8 text-start">
      ...
      <div className="grid grid-cols-3 gap-3 mb-8">
        {actionCards.map((card) => (
          <button
            ...
            className="p-4 rounded-xl bg-[rgb(var(--background-secondary))] border border-[rgb(var(--border-primary))] hover:border-[rgb(var(--border-focus)/0.40)] transition-all text-start group"
          >
