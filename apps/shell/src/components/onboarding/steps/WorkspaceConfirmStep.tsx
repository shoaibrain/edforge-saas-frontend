...
export function WorkspaceConfirmStep({ onNext, onBack }: OnboardingStepProps) {
  ...
  return (
    <div className="bg-[rgb(var(--background-secondary))] rounded-2xl p-9 border border-[rgb(var(--border-primary))]">
      ...
      {countryLabel && (
        <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-[rgb(var(--state-success-bg)/0.18)] border border-[rgb(var(--state-success-border)/0.35)] mb-6">
          <svg className="w-4 h-4 text-[rgb(var(--state-success-fg))]" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
