    ...
    <div className="max-w-6xl mx-auto px-6 py-8 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/inbox" className="text-sm text-[rgb(var(--action-secondary-fg))] font-medium hover:underline flex items-center">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <IntegrationCard
                ...
                icon={<Video className="w-6 h-6 text-[rgb(var(--action-primary-fg))]" />}
                iconBg="bg-[rgb(var(--state-info-fg))]"
                connected
              />
              <IntegrationCard
                name="Google Calendar"
                description="Sync your class schedules and events"
                icon={<Calendar className="w-6 h-6 text-[rgb(var(--action-primary-fg))]" />}
                iconBg="bg-[rgb(var(--state-success-fg))]"
                connected
              />
              <IntegrationCard
                name="Slack"
                description="Team communication and notifications"
                icon={<Slack className="w-6 h-6 text-[rgb(var(--action-primary-fg))]" />}
                iconBg="bg-[rgb(var(--state-info-fg))]"
                connected={false}
              />
              <IntegrationCard
                ...
                icon={<MessageCircleMore className="w-6 h-6 text-[rgb(var(--action-primary-fg))]" />}
                iconBg="bg-[rgb(var(--state-info-fg))]"
                connected={false}
              />
            </div>
        ...
        <div className="space-y-6">
          ...
          >
            <Card className="p-6 bg-gradient-to-br from-[rgb(var(--state-info-bg)/0.18)] to-[rgb(var(--state-info-bg)/0.10)] border-[rgb(var(--state-info-border)/0.35)]">
              ...
              <Button className="w-full bg-[rgb(var(--action-primary-bg))] hover:bg-[rgb(var(--action-primary-bg-hover))] text-[rgb(var(--action-primary-fg))]  dark:">
                Browse Integrations
              </Button>
            </Card>
          </motion.div>
...
function StatCard({
  ...
  const content = (
    <Card className="p-5 hover:border-[rgb(var(--border-focus)/0.35)] transition-all cursor-pointer h-full">
...
function IntegrationCard({ name, description, icon, iconBg, connected }: { name: string; description: string; icon: any; iconBg: string; connected: boolean }) {
  return (
    <Card className="p-4 flex items-center gap-4 hover:border-[rgb(var(--border-focus)/0.35)] transition-colors cursor-pointer">
      ...
      {connected ? (
        <div className="p-2 rounded-full bg-[rgb(var(--state-success-fg))]/10 text-[rgb(var(--state-success-fg))]">
          <CheckCircle2 className="w-5 h-5" />
        </div>
      ) : (
        <Button variant="ghost" size="sm" className="text-[rgb(var(--action-secondary-fg))]">
          Connect
        </Button>
      )}
    </Card>
