/**
 * ModuleOverviewPage - Local Implementation for Finance MFE
 * 
...
function ActionCard({ card, delay = 0 }: { card: ModuleActionCard; delay?: number }) {
    ...
    return (
        ...
        >
            ...
            >
                <Link to={card.href}>
                    <Card className="p-6 h-full hover:shadow-lg transition-shadow duration-300 cursor-pointer group border-[rgb(var(--border-primary))] hover:border-amber-500/30 dark:hover:border-amber-400/30">
                        ...
                        <h3 className="font-semibold text-[rgb(var(--text-primary))] mb-1 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">
                            {card.title}
                        </h3>
            ...
            >
                <div className="flex items-start gap-4">
                    <motion.div
                        ...
                        className="p-3 rounded-xl bg-gradient-to-br from-amber-500/15 to-orange-500/15 dark:from-amber-400/20 dark:to-orange-500/20 border border-amber-500/20 dark:border-amber-400/25 flex-shrink-0"
                    >
