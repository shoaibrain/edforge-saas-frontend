...
function MessagesOverviewPage() {
  return (
    <div className="max-w-6xl mx-auto px-6 py-8 space-y-8">
      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-[rgb(var(--text-primary))]">Communication Hub</h1>
          <p className="text-[rgb(var(--text-secondary))] mt-1">
            Manage your messages, meetings, and integrations in one place
          </p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/messages/inbox" className="text-sm text-teal-600 dark:text-cyan-400 font-medium hover:underline flex items-center">
...
function InboxRow({ name, role, message, time, unread }: { name: string; role: string; message: string; time: string; unread: boolean }) {
  return (
    <Link to="/messages/inbox" className="block hover:bg-[rgb(var(--interactive-hover))] transition-colors">
