...
export const Route = createFileRoute('/_protected/communications/messages')({
  beforeLoad: () => {
...
function ConversationItem({ 
  ...
  return (
    <button
      onClick={onClick}
      className={`w-full text-left p-4 border-b border-[rgb(var(--border-secondary))] transition-colors ${
        isSelected 
