 ...
 * 
 * Horizontal stepper showing wizard progress with:
...
import { useWizard, type WizardStepStatus } from './WizardContext'
      ...
      >
        ...
        <motion.div
          ...
          className={cn(
            ...
            status === 'completed' && 'ring-2 ring-teal-500/20 dark:ring-cyan-500/20'
          )}
        >
          {status === 'completed' ? (
            <motion.div
