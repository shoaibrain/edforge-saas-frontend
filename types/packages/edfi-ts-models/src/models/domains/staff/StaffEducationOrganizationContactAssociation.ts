export interface StaffEducationOrganizationContactAssociation {
  id?: string;
  /**
...
/**
 * This interface was referenced by `StaffEducationOrganizationContactAssociation`'s JSON-Schema
