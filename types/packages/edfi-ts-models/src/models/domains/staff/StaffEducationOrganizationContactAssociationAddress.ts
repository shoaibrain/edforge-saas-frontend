export interface StaffEducationOrganizationContactAssociationAddress {
  /**
...
/**
 * This interface was referenced by `StaffEducationOrganizationContactAssociationAddress`'s JSON-Schema
