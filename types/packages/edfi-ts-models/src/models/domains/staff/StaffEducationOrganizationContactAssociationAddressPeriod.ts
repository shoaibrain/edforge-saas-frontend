export interface StaffEducationOrganizationContactAssociationAddressPeriod {
  /**
...
/**
 * This interface was referenced by `StaffEducationOrganizationContactAssociationAddressPeriod`'s JSON-Schema
