export interface StaffDisciplineIncidentAssociationDisciplineIncidentParticipationCode {
  /**
...
/**
 * This interface was referenced by `StaffDisciplineIncidentAssociationDisciplineIncidentParticipationCode`'s JSON-Schema
