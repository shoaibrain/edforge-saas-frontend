export interface StaffEducationOrganizationContactAssociationTelephone {
  /**
...
/**
 * This interface was referenced by `StaffEducationOrganizationContactAssociationTelephone`'s JSON-Schema
