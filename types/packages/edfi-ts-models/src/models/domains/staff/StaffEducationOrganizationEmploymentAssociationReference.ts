export interface StaffEducationOrganizationEmploymentAssociationReference {
  /**
...
/**
 * This interface was referenced by `StaffEducationOrganizationEmploymentAssociationReference`'s JSON-Schema
