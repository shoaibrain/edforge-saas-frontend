export interface StaffEducationOrganizationAssignmentAssociation {
  id?: string;
  /**
...
/**
 * This interface was referenced by `StaffEducationOrganizationAssignmentAssociation`'s JSON-Schema
