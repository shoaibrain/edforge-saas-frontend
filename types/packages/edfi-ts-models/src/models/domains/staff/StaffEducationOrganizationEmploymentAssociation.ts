export interface StaffEducationOrganizationEmploymentAssociation {
  id?: string;
  /**
...
/**
 * This interface was referenced by `StaffEducationOrganizationEmploymentAssociation`'s JSON-Schema
