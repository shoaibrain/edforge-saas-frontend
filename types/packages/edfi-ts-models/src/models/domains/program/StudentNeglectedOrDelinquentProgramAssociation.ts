export interface StudentNeglectedOrDelinquentProgramAssociation {
  id?: string;
  /**
...
/**
 * This interface was referenced by `StudentNeglectedOrDelinquentProgramAssociation`'s JSON-Schema
