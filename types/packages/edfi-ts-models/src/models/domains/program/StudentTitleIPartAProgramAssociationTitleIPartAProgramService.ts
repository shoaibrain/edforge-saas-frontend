export interface StudentTitleIPartAProgramAssociationTitleIPartAProgramService {
  /**
...
/**
 * This interface was referenced by `StudentTitleIPartAProgramAssociationTitleIPartAProgramService`'s JSON-Schema
