export interface StudentCTEProgramAssociationCTEProgramService {
  /**
...
/**
 * This interface was referenced by `StudentCTEProgramAssociationCTEProgramService`'s JSON-Schema
