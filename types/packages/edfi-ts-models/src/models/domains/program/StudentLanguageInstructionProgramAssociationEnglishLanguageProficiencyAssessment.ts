export interface StudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment {
  /**
...
/**
 * This interface was referenced by `StudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment`'s JSON-Schema
