export interface StudentHomelessProgramAssociationHomelessProgramService {
  /**
...
/**
 * This interface was referenced by `StudentHomelessProgramAssociationHomelessProgramService`'s JSON-Schema
