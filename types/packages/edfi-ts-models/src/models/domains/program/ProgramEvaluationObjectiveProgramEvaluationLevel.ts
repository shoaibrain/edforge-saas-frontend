export interface ProgramEvaluationObjectiveProgramEvaluationLevel {
  /**
...
/**
 * This interface was referenced by `ProgramEvaluationObjectiveProgramEvaluationLevel`'s JSON-Schema
