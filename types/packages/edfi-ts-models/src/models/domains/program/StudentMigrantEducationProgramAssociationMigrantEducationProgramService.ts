export interface StudentMigrantEducationProgramAssociationMigrantEducationProgramService {
  /**
...
/**
 * This interface was referenced by `StudentMigrantEducationProgramAssociationMigrantEducationProgramService`'s JSON-Schema
