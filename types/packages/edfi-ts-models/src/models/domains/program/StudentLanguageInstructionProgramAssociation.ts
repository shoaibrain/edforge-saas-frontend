export interface StudentLanguageInstructionProgramAssociation {
  id?: string;
  /**
...
/**
 * This interface was referenced by `StudentLanguageInstructionProgramAssociation`'s JSON-Schema
