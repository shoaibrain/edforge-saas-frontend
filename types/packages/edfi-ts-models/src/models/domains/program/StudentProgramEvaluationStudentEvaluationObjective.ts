export interface StudentProgramEvaluationStudentEvaluationObjective {
  /**
...
/**
 * This interface was referenced by `StudentProgramEvaluationStudentEvaluationObjective`'s JSON-Schema
