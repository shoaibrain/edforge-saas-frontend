export interface StudentLanguageInstructionProgramAssociationLanguageInstructionProgramService {
  /**
...
/**
 * This interface was referenced by `StudentLanguageInstructionProgramAssociationLanguageInstructionProgramService`'s JSON-Schema
