export interface StudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramService {
  /**
...
/**
 * This interface was referenced by `StudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramService`'s JSON-Schema
