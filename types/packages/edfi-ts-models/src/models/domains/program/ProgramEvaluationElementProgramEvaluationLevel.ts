export interface ProgramEvaluationElementProgramEvaluationLevel {
  /**
...
/**
 * This interface was referenced by `ProgramEvaluationElementProgramEvaluationLevel`'s JSON-Schema
