export interface StudentProgramEvaluationStudentEvaluationElement {
  /**
...
/**
 * This interface was referenced by `StudentProgramEvaluationStudentEvaluationElement`'s JSON-Schema
