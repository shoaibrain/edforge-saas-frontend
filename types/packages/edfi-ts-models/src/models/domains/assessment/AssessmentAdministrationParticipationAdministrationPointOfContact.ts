export interface AssessmentAdministrationParticipationAdministrationPointOfContact {
  /**
...
/**
 * This interface was referenced by `AssessmentAdministrationParticipationAdministrationPointOfContact`'s JSON-Schema
