export interface AssessmentAdministrationAssessmentBatteryPart {
  assessmentBatteryPartReference: EdFiAssessmentBatteryPartReference;
  [k: string]: any | undefined;
}
/**
 * This interface was referenced by `AssessmentAdministrationAssessmentBatteryPart`'s JSON-Schema
