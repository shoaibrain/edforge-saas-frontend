export interface AssessmentScoreRangeLearningStandardLearningStandard {
  learningStandardReference: EdFiLearningStandardReference;
  [k: string]: any | undefined;
}
/**
 * This interface was referenced by `AssessmentScoreRangeLearningStandardLearningStandard`'s JSON-Schema
