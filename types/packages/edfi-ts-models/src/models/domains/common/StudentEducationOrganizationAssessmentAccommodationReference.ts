export interface StudentEducationOrganizationAssessmentAccommodationReference {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssessmentAccommodationReference`'s JSON-Schema
