export interface StudentEducationOrganizationAssessmentAccommodationGeneralAccommodation {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssessmentAccommodationGeneralAccommodation`'s JSON-Schema
