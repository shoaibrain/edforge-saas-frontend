export interface SurveySectionResponseStaffTargetAssociation {
  id?: string;
...
/**
 * This interface was referenced by `SurveySectionResponseStaffTargetAssociation`'s JSON-Schema
