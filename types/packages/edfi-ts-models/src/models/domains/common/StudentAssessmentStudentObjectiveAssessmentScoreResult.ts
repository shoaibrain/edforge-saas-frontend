export interface StudentAssessmentStudentObjectiveAssessmentScoreResult {
  /**
...
/**
 * This interface was referenced by `StudentAssessmentStudentObjectiveAssessmentScoreResult`'s JSON-Schema
