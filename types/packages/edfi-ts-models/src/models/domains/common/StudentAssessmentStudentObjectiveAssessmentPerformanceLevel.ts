export interface StudentAssessmentStudentObjectiveAssessmentPerformanceLevel {
  /**
...
/**
 * This interface was referenced by `StudentAssessmentStudentObjectiveAssessmentPerformanceLevel`'s JSON-Schema
