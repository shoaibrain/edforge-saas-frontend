export interface PostSecondaryInstitutionMediumOfInstruction {
  /**
...
/**
 * This interface was referenced by `PostSecondaryInstitutionMediumOfInstruction`'s JSON-Schema
