export interface StudentAssessmentRegistrationAssessmentCustomization {
  /**
...
/**
 * This interface was referenced by `StudentAssessmentRegistrationAssessmentCustomization`'s JSON-Schema
