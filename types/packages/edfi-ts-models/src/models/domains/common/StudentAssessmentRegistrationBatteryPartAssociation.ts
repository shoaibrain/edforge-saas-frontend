export interface StudentAssessmentRegistrationBatteryPartAssociation {
  id?: string;
...
/**
 * This interface was referenced by `StudentAssessmentRegistrationBatteryPartAssociation`'s JSON-Schema
