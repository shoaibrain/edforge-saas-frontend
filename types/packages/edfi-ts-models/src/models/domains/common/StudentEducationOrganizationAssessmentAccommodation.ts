export interface StudentEducationOrganizationAssessmentAccommodation {
  id?: string;
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssessmentAccommodation`'s JSON-Schema
