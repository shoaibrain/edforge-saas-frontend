export interface StudentAssessmentStudentObjectiveAssessment {
  /**
...
/**
 * This interface was referenced by `StudentAssessmentStudentObjectiveAssessment`'s JSON-Schema
