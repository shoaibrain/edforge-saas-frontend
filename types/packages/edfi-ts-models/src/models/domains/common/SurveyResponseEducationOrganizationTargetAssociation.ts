export interface SurveyResponseEducationOrganizationTargetAssociation {
  id?: string;
...
/**
 * This interface was referenced by `SurveyResponseEducationOrganizationTargetAssociation`'s JSON-Schema
