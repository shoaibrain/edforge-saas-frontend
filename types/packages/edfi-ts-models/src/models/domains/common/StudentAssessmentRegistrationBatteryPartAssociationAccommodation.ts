export interface StudentAssessmentRegistrationBatteryPartAssociationAccommodation {
  /**
...
/**
 * This interface was referenced by `StudentAssessmentRegistrationBatteryPartAssociationAccommodation`'s JSON-Schema
