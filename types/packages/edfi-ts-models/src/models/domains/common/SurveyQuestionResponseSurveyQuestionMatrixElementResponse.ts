export interface SurveyQuestionResponseSurveyQuestionMatrixElementResponse {
  /**
...
/**
 * This interface was referenced by `SurveyQuestionResponseSurveyQuestionMatrixElementResponse`'s JSON-Schema
