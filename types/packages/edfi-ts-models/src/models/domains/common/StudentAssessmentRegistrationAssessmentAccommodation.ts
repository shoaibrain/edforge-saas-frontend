export interface StudentAssessmentRegistrationAssessmentAccommodation {
  /**
...
/**
 * This interface was referenced by `StudentAssessmentRegistrationAssessmentAccommodation`'s JSON-Schema
