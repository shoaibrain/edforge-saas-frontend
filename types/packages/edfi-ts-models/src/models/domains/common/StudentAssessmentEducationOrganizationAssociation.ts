export interface StudentAssessmentEducationOrganizationAssociation {
  id?: string;
  /**
...
/**
 * This interface was referenced by `StudentAssessmentEducationOrganizationAssociation`'s JSON-Schema
