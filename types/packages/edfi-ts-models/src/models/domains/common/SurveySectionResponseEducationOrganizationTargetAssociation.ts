export interface SurveySectionResponseEducationOrganizationTargetAssociation {
  id?: string;
...
/**
 * This interface was referenced by `SurveySectionResponseEducationOrganizationTargetAssociation`'s JSON-Schema
