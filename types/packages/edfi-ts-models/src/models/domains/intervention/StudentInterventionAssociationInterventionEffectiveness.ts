export interface StudentInterventionAssociationInterventionEffectiveness {
  /**
...
/**
 * This interface was referenced by `StudentInterventionAssociationInterventionEffectiveness`'s JSON-Schema
