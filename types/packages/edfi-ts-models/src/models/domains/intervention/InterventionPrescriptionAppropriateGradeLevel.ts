export interface InterventionPrescriptionAppropriateGradeLevel {
  /**
...
/**
 * This interface was referenced by `InterventionPrescriptionAppropriateGradeLevel`'s JSON-Schema
