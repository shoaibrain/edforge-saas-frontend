export interface InterventionStudyLearningResourceMetadataURI {
  /**
...
/**
 * This interface was referenced by `InterventionStudyLearningResourceMetadataURI`'s JSON-Schema
