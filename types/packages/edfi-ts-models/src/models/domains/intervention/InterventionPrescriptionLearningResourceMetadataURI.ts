export interface InterventionPrescriptionLearningResourceMetadataURI {
  /**
...
/**
 * This interface was referenced by `InterventionPrescriptionLearningResourceMetadataURI`'s JSON-Schema
