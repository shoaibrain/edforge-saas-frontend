export interface StudentSpecialEducationProgramAssociationServiceProvider {
  /**
...
/**
 * This interface was referenced by `StudentSpecialEducationProgramAssociationServiceProvider`'s JSON-Schema
