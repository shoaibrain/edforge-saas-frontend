export interface StudentSpecialEducationProgramEligibilityAssociation {
  id?: string;
  /**
...
/**
 * This interface was referenced by `StudentSpecialEducationProgramEligibilityAssociation`'s JSON-Schema
