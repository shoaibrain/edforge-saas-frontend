export interface StudentSpecialEducationProgramAssociationSpecialEducationProgramService {
  /**
...
/**
 * This interface was referenced by `StudentSpecialEducationProgramAssociationSpecialEducationProgramService`'s JSON-Schema
