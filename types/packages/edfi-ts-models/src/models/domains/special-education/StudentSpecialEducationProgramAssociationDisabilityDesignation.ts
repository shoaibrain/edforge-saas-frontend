export interface StudentSpecialEducationProgramAssociationDisabilityDesignation {
  /**
...
/**
 * This interface was referenced by `StudentSpecialEducationProgramAssociationDisabilityDesignation`'s JSON-Schema
