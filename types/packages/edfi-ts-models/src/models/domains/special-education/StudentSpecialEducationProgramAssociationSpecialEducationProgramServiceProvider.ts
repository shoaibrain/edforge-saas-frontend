export interface StudentSpecialEducationProgramAssociationSpecialEducationProgramServiceProvider {
  /**
...
/**
 * This interface was referenced by `StudentSpecialEducationProgramAssociationSpecialEducationProgramServiceProvider`'s JSON-Schema
