export interface StudentSpecialEducationProgramAssociationDisability {
  /**
...
/**
 * This interface was referenced by `StudentSpecialEducationProgramAssociationDisability`'s JSON-Schema
