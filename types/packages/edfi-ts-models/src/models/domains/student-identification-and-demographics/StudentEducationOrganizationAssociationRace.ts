export interface StudentEducationOrganizationAssociationRace {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationRace`'s JSON-Schema
