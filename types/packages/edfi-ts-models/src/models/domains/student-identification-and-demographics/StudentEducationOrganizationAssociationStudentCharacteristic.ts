export interface StudentEducationOrganizationAssociationStudentCharacteristic {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationStudentCharacteristic`'s JSON-Schema
