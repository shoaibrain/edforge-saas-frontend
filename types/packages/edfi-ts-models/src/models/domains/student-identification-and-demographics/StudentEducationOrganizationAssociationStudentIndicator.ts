export interface StudentEducationOrganizationAssociationStudentIndicator {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationStudentIndicator`'s JSON-Schema
