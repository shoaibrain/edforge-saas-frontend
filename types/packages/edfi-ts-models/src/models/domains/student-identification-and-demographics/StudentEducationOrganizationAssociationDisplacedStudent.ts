export interface StudentEducationOrganizationAssociationDisplacedStudent {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationDisplacedStudent`'s JSON-Schema
