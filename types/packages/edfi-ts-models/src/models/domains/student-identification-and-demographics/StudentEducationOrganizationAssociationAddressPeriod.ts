export interface StudentEducationOrganizationAssociationAddressPeriod {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationAddressPeriod`'s JSON-Schema
