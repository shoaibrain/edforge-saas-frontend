export interface StudentEducationOrganizationResponsibilityAssociation {
  id?: string;
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationResponsibilityAssociation`'s JSON-Schema
