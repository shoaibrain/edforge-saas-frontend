export interface StudentEducationOrganizationAssociationTelephone {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationTelephone`'s JSON-Schema
