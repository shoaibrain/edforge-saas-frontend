export interface StudentEducationOrganizationAssociationDisability {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationDisability`'s JSON-Schema
