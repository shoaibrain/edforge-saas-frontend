export interface StudentEducationOrganizationAssociationStudentIdentificationCode {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationStudentIdentificationCode`'s JSON-Schema
