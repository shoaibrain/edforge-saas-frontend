export interface StudentTransportationStudentBusDetailsTravelDayofWeek {
  /**
...
/**
 * This interface was referenced by `StudentTransportationStudentBusDetailsTravelDayofWeek`'s JSON-Schema
