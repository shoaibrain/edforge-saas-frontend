export interface StudentTransportationStudentBusDetailsTravelDirection {
  /**
...
/**
 * This interface was referenced by `StudentTransportationStudentBusDetailsTravelDirection`'s JSON-Schema
