export interface StudentEducationOrganizationAssociationStudentIndicatorPeriod {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationStudentIndicatorPeriod`'s JSON-Schema
