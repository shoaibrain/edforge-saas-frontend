export interface StudentEducationOrganizationAssociationLanguage {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationLanguage`'s JSON-Schema
