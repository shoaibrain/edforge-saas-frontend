export interface StudentEducationOrganizationAssociationInternationalAddress {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationInternationalAddress`'s JSON-Schema
