export interface StudentSchoolAssociationAlternativeGraduationPlan {
  alternativeGraduationPlanReference: EdFiGraduationPlanReference;
  [k: string]: any | undefined;
}
/**
 * This interface was referenced by `StudentSchoolAssociationAlternativeGraduationPlan`'s JSON-Schema
