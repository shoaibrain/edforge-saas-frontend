export interface StudentEducationOrganizationAssociationStudentCharacteristicPeriod {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationStudentCharacteristicPeriod`'s JSON-Schema
