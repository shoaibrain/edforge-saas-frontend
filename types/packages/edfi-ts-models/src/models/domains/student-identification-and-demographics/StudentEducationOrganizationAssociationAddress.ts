export interface StudentEducationOrganizationAssociationAddress {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationAddress`'s JSON-Schema
