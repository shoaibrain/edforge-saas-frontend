export interface StudentEducationOrganizationAssociationReference {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationReference`'s JSON-Schema
