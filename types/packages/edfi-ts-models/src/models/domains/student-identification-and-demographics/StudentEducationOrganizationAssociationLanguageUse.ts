export interface StudentEducationOrganizationAssociationLanguageUse {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationLanguageUse`'s JSON-Schema
