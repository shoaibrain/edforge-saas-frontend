export interface StudentEducationOrganizationAssociationTribalAffiliation {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationTribalAffiliation`'s JSON-Schema
