export interface StudentEducationOrganizationAssociationDisabilityDesignation {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationDisabilityDesignation`'s JSON-Schema
