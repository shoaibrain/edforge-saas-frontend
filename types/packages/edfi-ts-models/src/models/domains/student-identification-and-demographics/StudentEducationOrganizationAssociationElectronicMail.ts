export interface StudentEducationOrganizationAssociationElectronicMail {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationElectronicMail`'s JSON-Schema
