export interface StudentEducationOrganizationAssociationAncestryEthnicOrigin {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationAncestryEthnicOrigin`'s JSON-Schema
