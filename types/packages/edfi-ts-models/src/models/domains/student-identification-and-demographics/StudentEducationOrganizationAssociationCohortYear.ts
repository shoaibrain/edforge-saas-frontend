export interface StudentEducationOrganizationAssociationCohortYear {
  /**
...
/**
 * This interface was referenced by `StudentEducationOrganizationAssociationCohortYear`'s JSON-Schema
