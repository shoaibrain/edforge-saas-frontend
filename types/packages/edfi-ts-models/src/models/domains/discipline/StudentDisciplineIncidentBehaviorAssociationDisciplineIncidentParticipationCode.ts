export interface StudentDisciplineIncidentBehaviorAssociationDisciplineIncidentParticipationCode {
  /**
...
/**
 * This interface was referenced by `StudentDisciplineIncidentBehaviorAssociationDisciplineIncidentParticipationCode`'s JSON-Schema
