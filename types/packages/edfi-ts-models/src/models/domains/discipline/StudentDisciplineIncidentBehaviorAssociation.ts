export interface StudentDisciplineIncidentBehaviorAssociation {
  id?: string;
  /**
...
/**
 * This interface was referenced by `StudentDisciplineIncidentBehaviorAssociation`'s JSON-Schema
