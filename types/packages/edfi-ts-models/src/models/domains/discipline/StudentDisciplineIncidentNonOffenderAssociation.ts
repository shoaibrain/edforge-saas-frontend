export interface StudentDisciplineIncidentNonOffenderAssociation {
  id?: string;
...
/**
 * This interface was referenced by `StudentDisciplineIncidentNonOffenderAssociation`'s JSON-Schema
