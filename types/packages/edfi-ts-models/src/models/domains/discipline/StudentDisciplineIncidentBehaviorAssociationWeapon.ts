export interface StudentDisciplineIncidentBehaviorAssociationWeapon {
  /**
...
/**
 * This interface was referenced by `StudentDisciplineIncidentBehaviorAssociationWeapon`'s JSON-Schema
