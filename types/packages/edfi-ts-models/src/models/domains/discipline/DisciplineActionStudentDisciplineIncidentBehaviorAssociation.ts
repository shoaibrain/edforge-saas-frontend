export interface DisciplineActionStudentDisciplineIncidentBehaviorAssociation {
  studentDisciplineIncidentBehaviorAssociationReference: EdFiStudentDisciplineIncidentBehaviorAssociationReference;
  [k: string]: any | undefined;
}
/**
 * This interface was referenced by `DisciplineActionStudentDisciplineIncidentBehaviorAssociation`'s JSON-Schema
