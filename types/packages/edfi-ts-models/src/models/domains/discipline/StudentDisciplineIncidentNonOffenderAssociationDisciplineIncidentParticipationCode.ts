export interface StudentDisciplineIncidentNonOffenderAssociationDisciplineIncidentParticipationCode {
  /**
...
/**
 * This interface was referenced by `StudentDisciplineIncidentNonOffenderAssociationDisciplineIncidentParticipationCode`'s JSON-Schema
