export interface StudentDisciplineIncidentBehaviorAssociationReference {
  /**
...
/**
 * This interface was referenced by `StudentDisciplineIncidentBehaviorAssociationReference`'s JSON-Schema
