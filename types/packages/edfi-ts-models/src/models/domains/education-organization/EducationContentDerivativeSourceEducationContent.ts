export interface EducationContentDerivativeSourceEducationContent {
  derivativeSourceEducationContentReference: EdFiEducationContentReference;
  [k: string]: any | undefined;
}
/**
 * This interface was referenced by `EducationContentDerivativeSourceEducationContent`'s JSON-Schema
