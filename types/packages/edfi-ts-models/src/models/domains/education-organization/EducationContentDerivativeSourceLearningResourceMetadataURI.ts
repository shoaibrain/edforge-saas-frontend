export interface EducationContentDerivativeSourceLearningResourceMetadataURI {
  /**
...
/**
 * This interface was referenced by `EducationContentDerivativeSourceLearningResourceMetadataURI`'s JSON-Schema
