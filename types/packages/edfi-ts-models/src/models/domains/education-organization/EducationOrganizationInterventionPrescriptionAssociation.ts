export interface EducationOrganizationInterventionPrescriptionAssociation {
  id?: string;
...
/**
 * This interface was referenced by `EducationOrganizationInterventionPrescriptionAssociation`'s JSON-Schema
