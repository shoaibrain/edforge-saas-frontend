export interface CourseTranscriptAlternativeCourseIdentificationCode {
  /**
...
/**
 * This interface was referenced by `CourseTranscriptAlternativeCourseIdentificationCode`'s JSON-Schema
