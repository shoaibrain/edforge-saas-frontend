export interface CourseTranscriptPartialCourseTranscriptAwards {
  /**
...
/**
 * This interface was referenced by `CourseTranscriptPartialCourseTranscriptAwards`'s JSON-Schema
