export interface GraduationPlanRequiredAssessmentPerformanceLevel {
  /**
...
/**
 * This interface was referenced by `GraduationPlanRequiredAssessmentPerformanceLevel`'s JSON-Schema
