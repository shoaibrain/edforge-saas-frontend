export interface StudentCompetencyObjectiveStudentSectionAssociation {
  studentSectionAssociationReference: EdFiStudentSectionAssociationReference;
  [k: string]: any | undefined;
}
/**
 * This interface was referenced by `StudentCompetencyObjectiveStudentSectionAssociation`'s JSON-Schema
