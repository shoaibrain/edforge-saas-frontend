export interface StudentCompetencyObjectiveGeneralStudentProgramAssociation {
  generalStudentProgramAssociationReference: EdFiGeneralStudentProgramAssociationReference;
  [k: string]: any | undefined;
}
/**
 * This interface was referenced by `StudentCompetencyObjectiveGeneralStudentProgramAssociation`'s JSON-Schema
