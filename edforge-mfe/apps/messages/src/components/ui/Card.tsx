...
export const CardHeader = forwardRef<HTMLDivElement, CardHeaderProps>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={twMerge('px-6 py-4 border-b border-[rgb(var(--border-secondary))]', className)}
      {...props}
    />
  )
)
...
export const CardFooter = forwardRef<HTMLDivElement, CardFooterProps>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={twMerge('px-6 py-4 border-t border-[rgb(var(--border-secondary))]', className)}
      {...props}
    />
  )
)
