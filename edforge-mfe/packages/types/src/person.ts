 ...
 */
export type PersonFormInput = Omit<
  Person,
 ...
 */
export type StudentFormInput = Omit<
  Student,
  'id' | 'createdAt' | 'updatedAt' | 'createdBy'
>
export type TeacherFormInput = Omit<
  Teacher,
  'id' | 'createdAt' | 'updatedAt' | 'createdBy'
>
export type StaffFormInput = Omit<
  Staff,
  'id' | 'createdAt' | 'updatedAt' | 'createdBy'
>
export type GuardianFormInput = Omit<
  Guardian,
  'id' | 'createdAt' | 'updatedAt' | 'createdBy'
>
