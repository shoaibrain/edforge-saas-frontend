...
const buttonVariants = cva(
  ...
  'inline-flex items-center justify-center font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none',
  {
    variants: {
      variant: {
        primary:
          'bg-teal-600 text-white hover:bg-teal-700 active:bg-teal-800 shadow-sm dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:active:bg-cyan-800',
        secondary:
        ...
        link: 'text-teal-600 underline-offset-4 hover:underline dark:text-cyan-400',
      },
      size: {
