...
const checks: FocusCheck[] = [
  ...
  {
    primitive: 'TablePresetTabs',
    file: 'packages/ui/src/components/data-table/TablePresetTabs.tsx',
    interactiveEvidence: /role="tab"/,
    focusEvidence: /focus-visible:ring|focus:ring|focus-visible:outline|focusRing/,
    semanticEvidence: /--border-focus|focusRing/,
  },
  {
    primitive: 'TableBulkBar',
    file: 'packages/ui/src/components/data-table/TableBulkBar.tsx',
    interactiveEvidence: /BulkAction|onClear/,
    focusEvidence: /focus-visible:ring|focus:ring|focus-visible:outline|focusRing/,
    semanticEvidence: /--border-focus|focusRing/,
  },
  {
    primitive: 'PageHeader pagebar',
    file: 'packages/ui/src/components/layout/PageHeader.tsx',
    interactiveEvidence: /onYearClick|PageBar/,
    focusEvidence: /focus-visible:ring|focus:ring|focus-visible:outline|focusRing/,
    semanticEvidence: /--border-focus|focusRing/,
  },
  {
...
describe('interactive primitive focus-ring baseline', () => {
  it('captures current primitives that still need semantic focus-visible coverage', () => {
    ...
    expect(statusByPrimitive).toEqual({
      ...
      TablePresetTabs: 'semantic-pass',
      TableBulkBar: 'semantic-pass',
      'PageHeader pagebar': 'semantic-pass',
