...
export function SkeletonCard({
  ...
  return (
    <div
      className={cn(
        'rounded-2xl border border-[rgb(var(--border-secondary))] bg-[rgb(var(--surface-secondary))] overflow-hidden',
        className
      )}
    >
      {hasHeader && (
    ...
    >
      <div className="overflow-x-auto">
        <table className="w-full">
          {hasHeader && (
            <thead className="border-b border-[rgb(var(--border-secondary))] bg-[rgb(var(--surface-tertiary))]">
              <tr>
...
export function SkeletonStatsCard({ className }: SkeletonStatsCardProps) {
  return (
    <div
      className={cn(
        'p-6 rounded-2xl border border-[rgb(var(--border-secondary))] bg-[rgb(var(--surface-secondary))]',
        className
      )}
    >
