...
export function DataTableViewOptions<TData>({
  ...
  return (
    <Popover className="relative">
      ...
      >
        <PopoverPanel className="absolute right-0 z-50 mt-1 w-48 origin-top-right rounded-xl bg-[rgb(var(--background-primary))] border border-[rgb(var(--border-primary)/0.35)] shadow-lg focus:outline-none overflow-hidden">
